...
<p align="center">
  <em>Front-End Checklist არის ვებ-გვერდის კომპონენტების სრული სია რომელიც უნდა შემოწმდეს საიტის იდეალურად ფუნქციონირებისთვის</em>
</p>
...
სია დაფუძნებულია Front-End დეველოპერების რამდენიმე წლიან გამოცდილებაზე და დამატებით მოიცავს სიებს სხვა წყაროებიდან.

## სარჩევი

1. **[Head](#head)**
2. **[HTML](#html)**
3. **[Web-ფონტები](#web-ფონტები)**
4. **[CSS](#css)**
5. **[სურათები](#სურათები)**
6. **[JavaScript](#javascript)**
7. **[უსაფრთხოება](#უსაფრთხოება)**
8. **[წარმადობა (Performance)](#წარმადობა)**
9. **[ხელმისაწვდომობა (Accessibility)](#ხელმისაწვდომობა)**
10. **[SEO](#seo)**

## როგორ გამოვიყენოთ?

**Front-End Checklist**-ის თითოეული პუნქტი სავალდებულია სრულყოფილი საიტისთვის, თუმცა ზოგიერთი ელემენტი შეიძლება იყოს ნაკლებ მნიშვნელოვანი, ან საერთოდ არ იყოს საჭირო თქვენი საიტისთვის (მაგალითად, სამართავი პანელისთვის თქვენ არ დაგჭირდებათ RSS). შეგხვდებათ აუცილებლობის 3 დონე:

* ![Low][low_img] ნიშნავს, რომ პუნქტი **რეკომენდირებულია**, მაგრამ შეიძლება მათი გამოტოვება საჭიროებისამებტ.
* ![Medium][medium_img] პუნქტი **მნიშვნელოვანია** და გამოტოვება შესაძლებელია ძალიან სპეციფიურ შემთხვევებში. თუმცა გამოტოვებამ შეიძლება უარყოფითი შედეგები მოგვცეს წარმადობაში ან SEO-ს საკითხებში.
* ![High][high_img] პუნქტი **სავალდებულია**. გამოტოვების შემთხვევაში საიტს ექნება პრობლემები წარმადობის, ხელმისაწვდომობის (accessibility) და SEO-ს საკითხებში. ასეთ პუნქტებს პირველ რიგში მიაქციეთ ყურადღება.

ზოგიერთ კომენტარზე დართულია იკონი, რომელიც დაგეხმარებათ მიხვდეთ რა სახის კონტენტია მოცემული:

* 📖: დოკუმენტაცია ან სტატია
* 🛠: Online ინსტრუმენტები / გასატესტი გვერდები
* 📹: მედია კონტენტი (ვიდეო, სურათები...)
